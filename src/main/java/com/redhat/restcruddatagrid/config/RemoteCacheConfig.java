// package com.redhat.restcruddatagrid.config;
...
//         LOGGER.info("###### host: " + hotrodProps.getProperty("infinispan.client.hotrod.server_list"));
//         LOGGER.info("###### username: '" + hotrodProps.getProperty("infinispan.hotrod.username") + "'");
//         LOGGER.info("###### password: '" + hotrodProps.getProperty("infinispan.hotrod.password") + "'");
